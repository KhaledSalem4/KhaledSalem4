...
![Web API](https://img.shields.io/badge/Web%20API-2C3E50?style=flat-square&logo=dotnet&logoColor=white)
...
**Tech Stack:** ASP.NET Core Web API | Entity Framework Core | SQL Server | Swagger
...
```csharp
var currentGoals = new List<string>
{
    "Master ASP.NET Core best practices",
    "Build production-ready Angular applications",
    "Contribute to open-source projects",
    "Land a junior frontend developer role",
...
![Profile Views](https://komarev.com/ghpvc/?username=KhaledSalem4&color=blueviolet&style=flat-square)
